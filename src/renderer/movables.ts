...
const _3 = () => "|-|-|" + "\n";
const __4 = (no: number, move: Moves, slf: string) => `|**${no}**|<a target="_blank" rel="noopener" href="https://github.com/tanishq-singh-2301/tic-tac-toe-readme/issues/new?title=ttt_move_${move.toLowerCase()}_${slf}_&labels=make+move&body=Jush+push+'Submit+new+issue'.+You+don't+need+to+do+anything+else.">${move}</a>|` + "\n";
